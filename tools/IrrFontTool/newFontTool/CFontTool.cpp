...
bool CFontTool::makeBitmapFont(u32 fontIndex, u32 charsetIndex, s32 fontSize, u32 textureWidth, u32 textureHeight, bool bold, bool italic, bool aa, bool alpha)
{
    ...
    for (currentImage= 0; currentImage < currentImages.size(); ++currentImage)
    {
        ...
        if (cClrBits <= 8)     // we're not supporting these
            ...
            cformat = (u32)video::ECOLOR_FORMAT::ECF_A1R5G5B5;
        else if (cClrBits <= 24)
            cformat = (u32)video::ECOLOR_FORMAT::ECF_R8G8B8;
        else
            cformat = (u32)video::ECOLOR_FORMAT::ECF_A8R8G8B8;
        ...
        if (cformat == (u32)video::ECOLOR_FORMAT::ECF_A8R8G8B8)
        {
        ...
        else if (cformat == (u32)video::ECOLOR_FORMAT::ECF_A1R5G5B5)
        {
            u8    *m;
