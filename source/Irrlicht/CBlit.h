 ...
 */
                                   ...
                                   u32 argb)
    {
        ...
        u32 *dst;
        dst = (u32*) ((u8*) t->lock() + (p0.Y * t->getPitch()) + (u32)((u64)p0.X << 2));
 ...
 */
                                   ...
                                   u32 argb)
    {
        ...
        u16 *dst;
        dst = (u16*) ((u8*) t->lock() + (p0.Y * t->getPitch()) + (u32)((u64)p0.X << 1));
 ...
 */
    ...
    {
        eBlitter             operation;
        video::ECOLOR_FORMAT destFormat;
        video::ECOLOR_FORMAT sourceFormat;
        tExecuteBlit         func;
    };

    static const blitterTable blitTable[] =
    {
        { BLITTER_TEXTURE, video::ECOLOR_FORMAT::ECF_UNKNOWN2, video::ECOLOR_FORMAT::ECF_UNKNOWN2, executeBlit_TextureCopy_x_to_x },
        { BLITTER_TEXTURE, video::ECOLOR_FORMAT::ECF_A1R5G5B5, video::ECOLOR_FORMAT::ECF_A8R8G8B8, executeBlit_TextureCopy_32_to_16 },
        { BLITTER_TEXTURE, video::ECOLOR_FORMAT::ECF_A1R5G5B5, video::ECOLOR_FORMAT::ECF_R8G8B8, executeBlit_TextureCopy_24_to_16 },
        { BLITTER_TEXTURE, video::ECOLOR_FORMAT::ECF_A8R8G8B8, video::ECOLOR_FORMAT::ECF_A1R5G5B5, executeBlit_TextureCopy_16_to_32 },
        { BLITTER_TEXTURE, video::ECOLOR_FORMAT::ECF_A8R8G8B8, video::ECOLOR_FORMAT::ECF_R8G8B8, executeBlit_TextureCopy_24_to_32 },
        { BLITTER_TEXTURE, video::ECOLOR_FORMAT::ECF_R8G8B8, video::ECOLOR_FORMAT::ECF_A1R5G5B5, executeBlit_TextureCopy_16_to_24 },
        { BLITTER_TEXTURE, video::ECOLOR_FORMAT::ECF_R8G8B8, video::ECOLOR_FORMAT::ECF_A8R8G8B8, executeBlit_TextureCopy_32_to_24 },
        { BLITTER_TEXTURE_ALPHA_BLEND, video::ECOLOR_FORMAT::ECF_A1R5G5B5, video::ECOLOR_FORMAT::ECF_A1R5G5B5, executeBlit_TextureBlend_16_to_16 },
        { BLITTER_TEXTURE_ALPHA_BLEND, video::ECOLOR_FORMAT::ECF_A8R8G8B8, video::ECOLOR_FORMAT::ECF_A8R8G8B8, executeBlit_TextureBlend_32_to_32 },
        { BLITTER_TEXTURE_ALPHA_COLOR_BLEND, video::ECOLOR_FORMAT::ECF_A1R5G5B5, video::ECOLOR_FORMAT::ECF_A1R5G5B5, executeBlit_TextureBlendColor_16_to_16 },
        { BLITTER_TEXTURE_ALPHA_COLOR_BLEND, video::ECOLOR_FORMAT::ECF_A8R8G8B8, video::ECOLOR_FORMAT::ECF_A8R8G8B8, executeBlit_TextureBlendColor_32_to_32 },
        { BLITTER_COLOR, video::ECOLOR_FORMAT::ECF_A1R5G5B5, video::ECOLOR_FORMAT::ECF_UNKNOWN, executeBlit_Color_16_to_16 },
        { BLITTER_COLOR, video::ECOLOR_FORMAT::ECF_A8R8G8B8, video::ECOLOR_FORMAT::ECF_UNKNOWN, executeBlit_Color_32_to_32 },
        { BLITTER_COLOR_ALPHA, video::ECOLOR_FORMAT::ECF_A1R5G5B5, video::ECOLOR_FORMAT::ECF_UNKNOWN, executeBlit_ColorAlpha_16_to_16 },
        { BLITTER_COLOR_ALPHA, video::ECOLOR_FORMAT::ECF_A8R8G8B8, video::ECOLOR_FORMAT::ECF_UNKNOWN, executeBlit_ColorAlpha_32_to_32 },
        { BLITTER_INVALID, video::ECOLOR_FORMAT::ECF_UNKNOWN, video::ECOLOR_FORMAT::ECF_UNKNOWN, 0 }
    };


    static inline tExecuteBlit getBlitter2(eBlitter operation, const video::IImage *dest, const video::IImage *source)
    {
        video::ECOLOR_FORMAT sourceFormat = (video::ECOLOR_FORMAT) (source ? source->getColorFormat() : video::ECOLOR_FORMAT::ECF_UNKNOWN);
        video::ECOLOR_FORMAT destFormat   = (video::ECOLOR_FORMAT) (dest ? dest->getColorFormat() : video::ECOLOR_FORMAT::ECF_UNKNOWN);
        ...
        while (b->operation != BLITTER_INVALID)
        {
            ...
            {
                if ((b->destFormat == video::ECOLOR_FORMAT::ECF_UNKNOWN || b->destFormat == destFormat) &&
                    (b->sourceFormat == video::ECOLOR_FORMAT::ECF_UNKNOWN || b->sourceFormat == sourceFormat))
                    return b->func;
                else if (b->destFormat == video::ECOLOR_FORMAT::ECF_UNKNOWN2 && (sourceFormat == destFormat))
                    return b->func;
            }
