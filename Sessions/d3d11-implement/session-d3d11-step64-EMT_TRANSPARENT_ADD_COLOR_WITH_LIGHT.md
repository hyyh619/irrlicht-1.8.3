...
The user wants me to implement a lighting version of PS_TRANSPARENT_ADD_COLOR, similar to what I did for PS_REFLECTION_2_LAYER. Let me first look at the current PS_TRANSPARENT_ADD_COLOR implementation.
...
{
  "path": "C:\\Development\\Graphics\\irrlicht-1.8.3\\source\\Irrlicht",
  "pattern": "PS_TRANSPARENT_ADD_COLOR\\("
}
```
...
Found 2 matches
C:\Development\Graphics\irrlicht-1.8.3\source\Irrlicht\PS_MaterialShaders.hlsl:
  Line 373: float4 PS_TRANSPARENT_ADD_COLOR(PS_INPUT_BASIC input) : SV_TARGET


C:\Development\Graphics\irrlicht-1.8.3\source\Irrlicht\CD3D11MaterialRenderer.h:
  Line 283: float4 PS_TRANSPARENT_ADD_COLOR(PS_INPUT_BASIC input) : SV_TARGET
...
Let me look at the PS_TRANSPARENT_ADD_COLOR function to understand what it does, and then create the lighting version.
...
<type>file</type>
<content>
278:     float4 lightingResult = diffuse + specular + ambient + emissive;
279:     float4 baseColor = texColor * lightingResult;
280:     return baseColor * reflection * 2.0;
281: }
282: 
283: float4 PS_TRANSPARENT_ADD_COLOR(PS_INPUT_BASIC input) : SV_TARGET
284: {
285:     float4 texColor = DiffuseTexture.Sample(LinearSampler, input.TexCoord);
286:     float4 result = texColor * input.Color;
287:     return result;
288: }
289: 
290: float4 PS_TRANSPARENT_ALPHA_CHANNEL(PS_INPUT_BASIC input) : SV_TARGET
291: {
292:     float4 texColor = DiffuseTexture.Sample(LinearSampler, input.TexCoord);
293:     float4 result = texColor * input.Color;
294:     result.a = texColor.a * input.Color.a;
295:     return result;
296: }
297: 

(Showing lines 278-297 of 748. Use offset=298 to continue.)
</content>
```
...
Now I need to add the lighting version. Let me add the new function after PS_TRANSPARENT_ADD_COLOR.
...
Now I need to add the same shader to PS_MaterialShaders.hlsl. Let me find the current PS_TRANSPARENT_ADD_COLOR location.
...
<type>file</type>
<content>
368: // EMT_TRANSPARENT_ADD_COLOR - Add source to dest (no alpha blend)
369: // SrcBlend: D3DBLEND_ONE
370: // DestBlend: D3DBLEND_INVSRCCOLOR
371: // ColorOp: D3DTOP_MODULATE, Tex * Diffuse
372: //==============================================================================
373: float4 PS_TRANSPARENT_ADD_COLOR(PS_INPUT_BASIC input) : SV_TARGET
374: {
375:     float4 texColor = DiffuseTexture.Sample(LinearSampler, input.TexCoord);
376:     float4 result = texColor * input.Color;
377:     return result; // Blend func: result + dest * (1 - result.rgb)
378: }
379: 
380: //==============================================================================
381: // EMT_TRANSPARENT_ALPHA_CHANNEL - Alpha blend with texture alpha
382: // SrcBlend: D3DBLEND_SRCALPHA
383: // DestBlend: D3DBLEND_INVSRCALPHA
384: // AlphaOp: D3DTOP_MODULATE, Tex * Diffuse (on stage 0)
385: // AlphaRef: MaterialTypeParam * 255
386: //==============================================================================
387: float4 PS_TRANSPARENT_ALPHA_CHANNEL(PS_INPUT_BASIC input) : SV_TARGET

(Showing lines 368-387 of 641. Use offset=388 to continue.)
</content>
```
...
Now I need to add the same function to PS_MaterialShaders.hlsl. Let me insert it after PS_TRANSPARENT_ADD_COLOR.
...
Now I need to add the enum value to EMaterialTypes.h and the switch case in CD3D11Driver.cpp. Let me find the right place for both.
...
<type>file</type>
<content>
88:              * bit transparent, and everything which was black is 100%
89:              * transparent and not visible. This material type is useful for
90:              * particle effects. */
91:             EMT_TRANSPARENT_ADD_COLOR,
92: 
93:             //! Makes the material transparent based on the texture alpha channel.
94:             /** The final color is blended together from the destination
95:              * color and the texture color, using the alpha channel value as
96:              * blend factor. Only first texture is used. If you are using
97:              * this material with small textures, it is a good idea to load

(Showing lines 88-97 of 296. Use offset=98 to continue.)
</content>
```
...
I need to add EMT_TRANSPARENT_ADD_COLOR_WITH_LIGHT after EMT_TRANSPARENT_ADD_COLOR (line 91), and also add the case for getMaterialTypeName.
...
<type>file</type>
<content>
275:                 case EMT_REFLECTION_2_LAYER: return "EMT_REFLECTION_2_LAYER";
276:                 case EMT_REFLECTION_2_LAYER_WITH_LIGHT: return "EMT_REFLECTION_2_LAYER_WITH_LIGHT";
277:                 case EMT_TRANSPARENT_ADD_COLOR: return "EMT_TRANSPARENT_ADD_COLOR";
278:                 case EMT_TRANSPARENT_ALPHA_CHANNEL: return "EMT_TRANSPARENT_ALPHA_CHANNEL";
279:                 case EMT_TRANSPARENT_ALPHA_CHANNEL_REF: return "EMT_TRANSPARENT_ALPHA_CHANNEL_REF";
280:                 case EMT_TRANSPARENT_VERTEX_ALPHA: return "EMT_TRANSPARENT_VERTEX_ALPHA";
281:                 case EMT_TRANSPARENT_REFLECTION_2_LAYER: return "EMT_TRANSPARENT_REFLECTION_2_LAYER";
282:                 case EMT_NORMAL_MAP_SOLID: return "EMT_NORMAL_MAP_SOLID";
283:                 case EMT_NORMAL_MAP_TRANSPARENT_ADD_COLOR: return "EMT_NORMAL_MAP_TRANSPARENT_ADD_COLOR";
284:                 case EMT_NORMAL_MAP_TRANSPARENT_VERTEX_ALPHA: return "EMT_NORMAL_MAP_TRANSPARENT_VERTEX_ALPHA";

(Showing lines 275-284 of 300. Use offset=285 to continue.)
</content>
```
...
Now I need to add the case for EMT_TRANSPARENT_ADD_COLOR_WITH_LIGHT in getMaterialTypeName.
...
Now I need to add the entry point mapping in CD3D11Driver.cpp
...
All 4 files have been updated for the new material type PS_TRANSPARENT_ADD_COLOR_WITH_LIGHT.




已完成。添加了 `PS_TRANSPARENT_ADD_COLOR_WITH_LIGHT` 函数，实现了带光照的透明添加颜色效果：

- **最终颜色** = texColor × lightingResult
- **Alpha** = texColor.a × input.Color.a（保持透明度混合）

修改了4个文件：
1. **CD3D11MaterialRenderer.h** - 添加了函数实现
2. **PS_MaterialShaders.hlsl** - 添加了 HLSL 实现
3. **EMaterialTypes.h** - 添加了 `EMT_TRANSPARENT_ADD_COLOR_WITH_LIGHT` 枚举值和字符串名称
4. **CD3D11Driver.cpp** - 添加了着色器入口点映射
