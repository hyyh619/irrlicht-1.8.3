...
protected:
    ...
    bool init(int argc, char *argv[])
    {
        ...
        const video::SColor colHighLight(col3dHighLight);
    ...
    bool update()
    {
        ...
        if (Device->isWindowActive() || Config.RenderInBackground)
        {
            ...
            // draw everything
            const video::SColor bkColor(skin->getColor(gui::EGDC_APP_WORKSPACE));
    ...
    void createDefaultTextures(video::IVideoDriver *driver)
    {
        ...
        video::IImage *imageA8R8G8B8 = driver->createImage (video::ECOLOR_FORMAT::ECF_A8R8G8B8, core::dimension2d<u32>(width, height));
