...
#undef PI64
    ...
    #define IR(x) ((u32&)(x))
#else
        inline constexpr u32 IR(f32 x) noexcept
        {
            inttofloat tmp = { 0 }; tmp.f = x; return tmp.u;
        }
#endif
    ...
    #define FR(x) ((f32&)(x))
#else
        inline constexpr f32 FR(u32 x) noexcept
        {
            inttofloat tmp = { 0 }; tmp.u = x; return tmp.f;
        }
        inline constexpr f32 FR(s32 x) noexcept
        {
            inttofloat tmp = { 0 }; tmp.s = x; return tmp.f;
        }
#endif
